...
Estou desenvolvendo um wargame naval multiplayer histórico chamado "Guerra das
Malvinas/Falkland 1982" (Node.js + Socket.IO) e quero treinar um bot de
imitation learning usando PyTorch.

**Repositório:** velhomarinheiro/falklands-malvinas
**Branch de trabalho:** claude/replicate-wargame-to-falklands-uwx3jc
...
- O estado do jogo usa um grid hexagonal flat-top de 10×20 células
